...
2. Nous allons aussi créer un tableau de lettres. Puisque la langue des baleines contient que des voyelles, créer une variable `voyels` de type tableau contenant toutes les voyelles.
